...
exports.getJeansProducts = async (req, res) => {
  try {
    const product = await Product.find({ category: "Jeans" });
...
exports.getShirtsProducts = async (req, res) => {
  try {
    const product = await Product.find({ category: "Shirts" });
...
exports.getJacketsProducts = async (req, res) => {
  try {
    const product = await Product.find({ category: "Jackets" });
...
exports.getPerfumesProducts = async (req, res) => {
  try {
    const product = await Product.find({ category: "Perfumes" }); // category: "Perfumes" asme as front end
    if (product.length == 0) {
      res.send("not found product");
    } else {
      res.send(product);
...
exports.getCosmeticsProducts = async (req, res) => {
  try {
    const product = await Product.find({ category: "Cosmetics" });
...
exports.getFootwareProducts = async (req, res) => {
  try {
    const product = await Product.find({ category: "Footwares" });
